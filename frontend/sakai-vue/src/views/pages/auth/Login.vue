                ...
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Welcome to EazyDeploy!</div>
                            <span class="text-muted-color font-medium">登录以继续</span>
                        </div>

                        <!-- 登录表单 -->
                        <div>
                            <label for="username" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">用户名</label>
                            <InputText id="username" type="text" placeholder="请输入用户名" class="w-full md:w-[30rem] mb-6" v-model="loginInfo.username" />

                            <label for="password" class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">密码</label>
                            <Password id="password" v-model="loginInfo.password" placeholder="请输入密码" :toggleMask="true" class="mb-4 w-full" fluid :feedback="false"></Password>
                        ...
                        <!-- 注册表单 -->
                        <div class="font-medium text-surface-900 dark:text-surface-0 text-xl mb-2">新用户？立即注册</div>
                        <div>
                            <label for="registerEmail" class="block mb-2">用户名</label>
                            <InputText id="registerEmail" v-model="registerInfo.username" class="w-full mb-4" placeholder="请输入用户名" />

                            <label for="registerPassword" class="block mb-2">密码</label>
                            <Password id="registerPassword" v-model="registerInfo.password" :toggleMask="true" :feedback="false" class="mb-4 w-full" fluid placeholder="请输入密码"></Password>

                            <Button label="注册" class="w-full" @click="handleRegister"></Button>
                        </div>
                    </div>
                </div>
            </div>
