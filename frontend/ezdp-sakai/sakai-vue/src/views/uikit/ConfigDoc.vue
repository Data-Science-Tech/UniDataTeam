    ...
    <div class="container">
        ...
        <form @submit.prevent="createModelConfig" class="form-container">
            ...
            <div class="form-group">
                ...
                <input type="number" v-model="modelConfig.learningRate" id="learningRate" class="input-field"
                    step="0.005" />
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" v-model="modelConfig.momentumValue" id="momentumValue" class="input-field"
                    step="0.1" />
            </div>

            <div class="form-group">
                <label for="weightDecay">权重衰退(Weight Decay):</label>
                <input type="number" v-model="modelConfig.weightDecay" id="weightDecay" class="input-field"
                    step="0.0001" />
            </div>
